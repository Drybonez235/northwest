...
function nw_render_ministry_meta_box($post) {
    ...
    <div class="nw-admin-field"><label>Ministry Leader Title</label><input type="text" name="_ministry_leader_title" value="<?php echo esc_attr($values['leader_title']); ?>"></div>
